...
type OpenPill = 'dates' | 'price' | 'type' | null;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 pt-4 pb-12 lg:pt-6">
        ...
        {/* ── Pill filter bar ── */}
        <div ref={pillBarRef} className="mb-4">
          {/* Scrollable pill row — dropdowns must NOT live here (overflow clips them) */}
          ...
          {/* Dropdown panels — outside the overflow container so they're never clipped */}
          {openPill === 'dates' && (
            <div className="mt-2 bg-white border border-gray-200 rounded-2xl shadow-xl p-4 w-fit min-w-[240px]">
          ...
          {openPill === 'price' && (
            <div className="mt-2 bg-white border border-gray-200 rounded-2xl shadow-xl p-4 w-fit min-w-[220px]">
          ...
          {openPill === 'type' && (
            <div className="mt-2 bg-white border border-gray-200 rounded-2xl shadow-xl py-2 w-fit min-w-[170px]">
